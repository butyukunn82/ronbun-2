const CACHE='st-reflex-2026-v4';
const ASSETS=['./','./index.html','./styles.css','./app.js','./questions.js','./questions-extra.js','./thinking.js','./manifest.webmanifest','./icon-192.png','./icon-512.png'];
