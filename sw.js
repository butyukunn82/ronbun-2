const CACHE='st-reflex-2026-v8';
const ASSETS=['./','./index.html','./styles.css','./app.js','./questions.js','./questions-extra.js','./project-management-terms.js','./glossary-meta.js','./glossary-ui.js','./thinking.js','./manifest.webmanifest','./icon-192.png','./icon-512.png'];
